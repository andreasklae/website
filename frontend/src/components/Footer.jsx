    ...
    <footer className="bg-gray-900 text-gray-300 py-12">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col space-y-8">
          {/* Top row - Contact (other pages only) + Social Links (all pages) */}
          <div
          ...
          >
            ...
            <div className="flex flex-wrap items-center justify-center gap-4">
              ...
              <a
                href="https://www.linkedin.com/in/andreas-kl%C3%A6boe-80a6523b8"
                target="_blank"
                rel="noopener noreferrer"
                className="glass-bubble inline-flex items-center px-4 py-2 bg-[#0A66C2]/90 text-white rounded-xl text-sm font-semibold transition-all duration-300 hover:scale-105 hover:shadow-xl"
              >
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 border-t border-gray-800 pt-8">
